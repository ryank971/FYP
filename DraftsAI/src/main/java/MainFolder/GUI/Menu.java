    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(playCheckers, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        checkers.setVisible(true);
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        /* If Nimbus (itroduced in Java SE 6) is not available, stay with the default look and feel.
...
//        while ((checkers.isOver(CheckersBoard) == false || reversi.isOver(ReversiBoard) == false)) {
//
//            if (CheckersBoard.turn == 1) {
//                reversiRandom.makeMove(ReversiBoard);
//                randomAgent.makeMove(CheckersBoard);
//                Thread.sleep(500);
//            } else {
//                reversiRandom.makeMove(ReversiBoard);
//                randomAgent.makeMove(CheckersBoard);
...
//        }
    ...
    public static JPanel ReversiDemo() throws IOException {
        JPanel pane = new JPanel();
        pane.setBounds(600, 250, 350, 350);
        pane.setLayout(new GridLayout(rows, columns));
        Color temp;
        for (int i = 0; i < rows; i++) {
            if (i % 2 == 0) {
