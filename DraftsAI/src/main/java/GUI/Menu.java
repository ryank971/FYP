...
public class Menu extends javax.swing.JFrame {
    ...
    static int[] Move;
    static CheckersRandom randomAgent = new CheckersRandom();
    static CheckersMinimax minimaxAgent = new CheckersMinimax();
    static CheckersAlphaBeta alphaBetaAgent = new CheckersAlphaBeta();
    static Board board = new Board();

    static Reversi reversi = new Reversi();
    static Checkers checkers = new Checkers();
    static ReversiRandom reversiRandom = new ReversiRandom();
    static ReversiMinimax reversiMinimax = new ReversiMinimax();
    static ReversiAlphaBeta alphaBetaReverse = new ReversiAlphaBeta();
